...
class PropertyDetailsState extends State<PropertyDetails>
  ...
  // Flags to prevent multiple taps
  ...
  Future<void> onBackPress({required bool isFromAppBar}) async {
    ...
    if (widget.fromPropertyAddSuccess ?? false) {
      // Use a safer navigation approach to avoid empty Navigator history
      if (!mounted) return;
        ...
        children: [
          ...
          UiUtils.buildButton(
            ...
            onPressed: () async {
              ...
              if (_isMortgageCalculatorOpening) return;
